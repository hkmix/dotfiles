...
export PATH="/usr/local/Cellar:/usr/local/bin/tex:/usr/local/sbin:/usr/local/opt/coreutils/libexec/gnubin:/Applications/Eclipse.app/Contents/Eclipse:/usr/local/bin:$HOME/.cabal/bin:$HOME/.local/bin:$HOME/.bin:$PATH"
...
export INFINALITY_FT_FILTER_PARAMS="06 55 84 55 06"
